...
function encodeToRot13(str) {
  ...
  for (let i = 0; i < str.length; i += 1) {
    // у прописных CharCodes от 97 до 122;
    // у заглавных CharCodes от 65 до 90;
    let charCode = 0;
    if (str.charCodeAt(i) === 32 || str.charCodeAt(i) === 33 || str.charCodeAt(i) === 63) {
      charCode = str.charCodeAt(i);
    } else if ((str.charCodeAt(i) + 13) > 122) {
      charCode = str.charCodeAt(i) + 13 - 122 + 96;
    } else if ((str.charCodeAt(i) + 13) > 90 && (str.charCodeAt(i) + 13) < 104) {
      charCode = str.charCodeAt(i) + 13 - 90 + 64;
    } else {
